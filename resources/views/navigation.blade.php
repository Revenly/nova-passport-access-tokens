<router-link tag="h3" :to="{name: 'nova-passport-manager'}" class="cursor-pointer flex items-center font-normal dim text-white mb-6 text-base no-underline">
    <svg
            class="sidebar-icon fill-current"
            aria-hidden="true"
            focusable="false"
            role="img"
